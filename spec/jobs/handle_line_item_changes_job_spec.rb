...
describe 'HandleLineItemChangesJob' do
  before :all do
    ...
    CarrierAgency.where(agency_id: 1).each do |carrier_agency|
      ::CarrierAgency.create!(agency: agency, carrier: carrier_agency.carrier, carrier_agency_policy_types_attributes: carrier_agency.carrier.carrier_policy_types.map do |cpt|
        {
