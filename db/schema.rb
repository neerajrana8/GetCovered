...
ActiveRecord::Schema.define(version: 2023_05_24_230059) do
  ...
  create_table "checked_files", force: :cascade do |t|
    t.string "name"
    t.string "checksum"
  ...
  create_table "contact_records", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.text "body"
    t.string "source", default: "System Mails"
  ...
  create_table "leases", force: :cascade do |t|
    ...
    t.boolean "excluded_from_compliance", default: false, null: false
    t.date "renewal_date"
  ...
  create_table "policies", force: :cascade do |t|
    ...
    t.integer "renewal_status", default: 0
  ...
  create_table "reporting_unit_coverage_entries", force: :cascade do |t|
    ...
    t.index ["report_time", "occupied"], name: "index_ruce_on_o"
  end
  ...
  create_table "reports", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "type"
    t.string "reportable2_type"
    t.bigint "reportable2_id"
