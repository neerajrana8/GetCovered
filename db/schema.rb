...
ActiveRecord::Schema.define(version: 2022_08_24_100413) do
  ...
  create_table "lead_events", force: :cascade do |t|
    ...
    t.index ["session_id"], name: "index_lead_events_on_session_id"
  end
  ...
  add_foreign_key "lead_events", "sessions"
