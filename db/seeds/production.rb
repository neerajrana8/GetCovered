# Initial Production Setup File
# file: db/seeds/staging.rb
...
@carriers.each do |c|
  ...
  if carrier.save!
    ...
    if carrier.id == 1
	    ...
	    ActionMailer::Base.mail(from: 'info@getcoveredinsurance.com', to: ['dylan@getcoveredllc.com', 'brandon@getcoveredllc.com'], subject: "Production Access Token", body: message).deliver
...
if @get_covered.save
  ...
  @get_covered.billing_strategies.create!(title: 'Bi-Annually', enabled: true, 
  		                                      ...
  		                                      carrier: @qbe, policy_type: PolicyType.find(1), carrier_code: "SA", 
                                    				fees_attributes: [service_fee])
  ...
  @get_covered.billing_strategies.create!(title: 'Quarterly', enabled: true, 
  		                                      ...
  		                                      carrier: @qbe, policy_type: PolicyType.find(1), carrier_code: "QT", 
                                    				fees_attributes: [service_fee])
  ...
  @get_covered.billing_strategies.create!(title: 'Monthly', enabled: true, 
  		                                      ...
  		                                      renewal: { payments: [8.37, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33], 
  		                                                      payments_per_term: 12, remainder_added_to_deposit: true },
  		                                      carrier: @qbe, policy_type: PolicyType.find(1), carrier_code: "QBE_MoRe", 
                                    				fees_attributes: [service_fee])
...
if @cambridge.save    
  ...
  @cambridge.billing_strategies.create!(title: 'Annually', enabled: true, carrier: @qbe, carrier_code: "M09",
		                                      new_business: { payments: [25.03, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33, 0, 0], 
		                                                      payments_per_term: 12, remainder_added_to_deposit: true }, 
                                    				  policy_type: PolicyType.find(1), 
                                      				fees_attributes: [
  ...
  @cambridge.billing_strategies.create!(title: 'Bi-Annually', enabled: true, carrier_code: "SA", 
    		                                      new_business: { payments: [50, 0, 0, 0, 0, 0, 50, 0, 0, 0, 0, 0], 
    		                                                      payments_per_term: 2, remainder_added_to_deposit: true },
  ...
  @cambridge.billing_strategies.create!(title: 'Quarterly', enabled: true, carrier_code: "QT", 
    		                                      new_business: { payments: [25, 0, 0, 25, 0, 0, 25, 0, 0, 25, 0, 0], 
    		                                                      payments_per_term: 4, remainder_added_to_deposit: true },
    		                                      carrier: @qbe, policy_type: PolicyType.find(1), 
                                      				fees_attributes: [
  ...
  @cambridge.billing_strategies.create!(title: 'Monthly', enabled: true, carrier_code: "QBE_MoRe", 
    		                                      new_business: { payments: [22.01, 7.09, 7.09, 7.09, 7.09, 7.09, 7.09, 7.09, 7.09, 7.09, 7.09, 7.09], 
    		                                                      payments_per_term: 12, remainder_added_to_deposit: true },
    		                                      renewal: { payments: [8.37, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33, 8.33], 
    		                                                      payments_per_term: 12, remainder_added_to_deposit: true },
