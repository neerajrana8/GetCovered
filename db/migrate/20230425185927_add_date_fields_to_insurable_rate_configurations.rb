class AddDateFieldsToInsurableRateConfigurations < ActiveRecord::Migration[6.1]
  def change
    ...
    add_column :insurable_rate_configurations, :end_date, :date, null: true, default: Date.parse("1 January, 2024")
    ...
    add_column :insurable_geographical_categories, :irc_cutoffs, :jsonb, null: false, default: {}
  end
end
