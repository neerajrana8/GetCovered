##
# V2 StaffAgency Notifications Controller
# File: app/controllers/v2/staff_agency/notifications_controller.rb

module V2
  module StaffAgency
    class NotificationsController < StaffAgencyController
