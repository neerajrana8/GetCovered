    ...
    module SpecialTasks
      class LeaseCoverageReportsController < StaffSuperAdminController
        ...
        GOOSE_RESPONSES = [
          ...
          "Softly gliding o'er the waves<br></br>providing data unto knaves<br></br>and lords of men if they should ask<br></br>--thus I describe my goosely task.",
          ...
          "What's the difference between a goose and a swan? Grace of form? Yeah I guess, that's true, sure. But there's a more important difference: work ethic.",
