##
# V2 StaffAccount PolicyQuotes Controller
# File: app/controllers/v2/staff_account/policy_quotes_controller.rb

module V2
  module StaffAccount
    class PolicyQuotesController < StaffAccountController
