##
# V2 StaffAccount Carrier Insurable Profiles Controller
# File: app/controllers/v2/staff_account/carrier_insurable_profiles_controller.rb

module V2
  module StaffAccount
    class CarrierInsurableProfilesController < StaffAccountController
