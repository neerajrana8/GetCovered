...
module V2
  module StaffAccount
    class MasterPoliciesController < StaffAccountController
      ...
      def index
        master_policies_relation = Policy.where(policy_type_id: PolicyType.master.ids, account: @account).order(created_at: :desc)
      ...
      def set_policy
        @master_policy = Policy.find_by(policy_type_id: PolicyType.master.ids, id: params[:id], account: @account)
