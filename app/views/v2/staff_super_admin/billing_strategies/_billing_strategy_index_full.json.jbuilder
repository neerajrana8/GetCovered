json.partial! "v2/staff_super_admin/billing_strategies/billing_strategy_index_fields.json.jbuilder",
...
json.carrier do
  unless billing_strategy.carrier.nil?
    json.partial! "v2/staff_super_admin/carriers/carrier_short_fields.json.jbuilder",
