json.partial! "v2/staff_agency/accounts/account_show_fields.json.jbuilder",
  account: account
...
json.branding_profiles do
  unless account.branding_profiles.nil?
    json.array! account.branding_profiles do |account_branding_profiles|
      json.partial! "v2/staff_agency/branding_profiles/branding_profile_index_fields.json.jbuilder",
