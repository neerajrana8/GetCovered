...
json.invoice do
  json.partial! "v2/staff_account/invoices/invoice_short_full",
    invoice: payment.invoice

  json.user do
    json.partial! "v2/staff_account/users/user_short_full", 
      user: payment.invoice.user
  end unless payment.invoice.user.nil?

  json.policy do
    json.partial! "v2/staff_account/policies/policy_short_full", 
