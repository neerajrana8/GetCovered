json.partial! "v2/staff_account/charges/charge_show_fields.json.jbuilder",
  charge: charge
...
json.disputes do
  unless charge.disputes.nil?
    json.array! charge.disputes do |charge_disputes|
      json.partial! "v2/staff_account/disputes/dispute_show_full.json.jbuilder",
...
#      json.partial! "v2/staff_account/stripe_refunds/stripe_refund_show_full.json.jbuilder",
