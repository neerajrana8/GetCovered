        ...
        def execute
          ...
          relevant_tenants.each.with_index do |tenant, tenant_index|
            ...
            if in_system.include?(tenant["Id"])
              ...
              lease.month_to_month = ( lease.start_date && lease.end_date && lease.end_date < lease.start_date && (RESIDENT_STATUSES['present'].include?(tenant['Status']) || RESIDENT_STATUSES['future'].include?(tenant['Status']) || tenant['Status'] == 'Applicant') )
