module Reports
  class DailySalesAllJob < ApplicationJob
    ...
    def perform
      range_end = Time.zone.now.yesterday.end_of_day
      range_start_yesterday = Time.zone.now.yesterday.beginning_of_day
      range_start_week = (Time.zone.now - 7.days).beginning_of_day
      range_start_thirty = (Time.zone.now - 30.days).beginning_of_day
