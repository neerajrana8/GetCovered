class CommissionItem < ApplicationRecord
  ...
  private
    ...
    def set_analytics_fields
      ...
      self.policy_id ||= (self.commissionable.policy_premium_item.policy_id || self.commissionable.policy_premium_item.policy_quote&.policy_id) if self.policy_id.nil? && self.commissionable_type == 'PolicyPremiumItemCommission'
